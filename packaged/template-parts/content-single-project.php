...
?>
    ...
    <div class="chapter">
        <h6 class="chapter-link"><?php esc_html_e( 'Site de l\'artiste', 'orenda_art' ); ?></h6>
        <h6 class="chapter-link"><?php esc_html_e( 'Oeuvres disponibles', 'orenda_art' ); ?></h6>
        <h6 class="chapter-link"><?php esc_html_e( 'Télécharger le CV', 'orenda_art' ); ?></h6>
    </div>
